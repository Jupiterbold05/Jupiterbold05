...
const OwnerNumber = "2348084644182"
const owner = "2348084644182"
const Owner = "2348084644182" 
...
⚙️ 𖤐 *𝙈𝙤𝙙𝙚:* ${currentMode}

📜 𖤐 *𝙎𝙥𝙚𝙡𝙡𝙨 𝙇𝙤𝙖𝙙𝙚𝙙:* ${commands.length} incantations
...
🏚️ 𖤐 *𝘿𝙖𝙩𝙖𝙘𝙧𝙞𝙥𝙩:* ${
  process.env.MONGO_URI?.includes("mongodb")
    ...
    ? "📖 Postgrimoire"
    : "🩸 The Core of Platinum"
}

🧿 𖤐 *𝙎𝙞𝙜𝙞𝙡:* "${prefix}" — the mark of command

⛧ 𝖙𝖍𝖊 𝖈𝖆𝖙𝖍𝖊𝖉𝖗𝖆𝖑 𝖎𝖘 𝖗𝖊𝖆𝖉𝖞... 𝖒𝖆𝖞 𝖙𝖍𝖊 𝖘𝖍𝖆𝖉𝖔𝖜𝖘 𝖔𝖇𝖊𝖞.
`;


conn.sendMessage(conn.authState.creds.me.id, { 
     text: up
 });
        ...
        conn.ev.on('messages.upsert', async (mek) => {
            ...
            // *** NEW: Process leveling for group messages.
            // *** END NEW LEVELING HANDLE
